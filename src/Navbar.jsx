...
const Navbar = () => {
  ...
  <div className="container-fluid">
    <NavLink exact className="navbar-brand" to="/">ALOKE Stainless Steel</NavLink>
    ...
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
      <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li className="nav-item">
          <NavLink exact activeClassName='menu_active' className="nav-link" to="/services">Products</NavLink>
        </li>
        <li className="nav-item">
